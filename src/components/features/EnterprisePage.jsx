...
const FeatureCard = memo(function FeatureCard({
  ...
  return (
    <div className="group cursor-pointer" onMouseEnter={onActivate}>
...
const CTASection = memo(function CTASection({ onContactSales }) {
  const buttonClasses = [
    "px-12 py-4",
...
const FeaturesGrid = memo(function FeaturesGrid({ activeFeature, setActiveFeature }) {
  return (
...
export default function EnterprisePage() {
  ...
  return (
    <div className="bg-[#0A0A0A] text-white selection:bg-violet-400 selection:text-black">
      ...
      <CTASection onContactSales={handleContactSales} />
    </div>
  );
}