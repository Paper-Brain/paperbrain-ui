...
function SolutionCard({ feature, isActive, onMouseEnter }) {
  const cardClasses = [
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-24">
            ...
            <p className="text-lg md:text-xl text-gray-400 font-light leading-relaxed mt-6 mb-12 max-w-3xl mx-auto">
              From startups to enterprises, discover how our AI-powered tools
              adapt to your development needs and enhance your coding workflow.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {SOLUTIONS_DATA.map((feature, index) => (
              <SolutionCard
                key={index}
                feature={feature}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <button
            className={
              ...
              "text-blue-800 text-sm tracking-wider transition-colors " +
              "duration-300 flex items-center justify-center mx-auto group"
            }
            type="button"
            GET STARTED
