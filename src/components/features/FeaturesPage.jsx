...
function FeatureCard({ feature, isActive, onMouseEnter }) {
...
function FeaturesGrid({ features, activeFeature, setActiveFeature }) {
  return (
...
export default function FeaturesPage() {
  ...
  const handleContactSales = () => navigate("/request-demo");
  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-6">
        <SectionHeader title="POWERFUL CAPABILITIES" subtitle />
        <FeaturesGrid
      ...
      <CTASection onClick={handleContactSales} />
    </div>
  );
}
>