...
const HeroSection = ({ onDemo, onLearnMore }) => (
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <button
              ...
              className={
                ...
                "text-black text-sm font-semibold tracking-wide rounded-lg " +
...
const NovaPro = () => {
  ...
  return (
    <div className="relative min-h-screen bg-[#050505] text-white selection:bg-violet-500/30 selection:text-violet-200 overflow-hidden font-sans">
      ...
      <HeroSection onDemo={handleRequestDemo} onLearnMore={handleLearnMore
