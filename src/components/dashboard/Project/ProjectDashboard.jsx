...
import { useState, useEffect, useCallback } from "react";
   ...
   UserDropdown from '../../auth/UserDropdown.jsx';
       ...
       <nav className="py-4" aria-label="Sidebar navigation">
         {NAVIGATION_ITEMS.map((item) => (
           <button
             ...
             className={`w-full flex items-center gap-3 px-4 py-2 hover:bg-white/5 transition-colors font-extralight focus:outline-none focus:ring-1 focus:ring-violet-400 rounded
           ...
           <div className="flex items-center justify-between gap-3 w-full">
             ...
             <div className="flex items-center gap-4">
               ...
               <div
                 ...
                 onMouseEnter={onToggleDropdown.bind(null, true)}
                 onMouseLeave={onToggleDropdown.bind(null, false)}
               >
            ...
            <div className="hidden md:flex items-center gap-2 text-sm font-extralight overflow-x-auto">
              ...
              <div className="relative flex-1">
                ...
                <input
                  ...
                  placeholder="Search"
                  className={[
                    'w-full', 'pl-10', 'pr-4', 'py-1.5', 'bg-transparent',
                    'border', 'border-white/10', 'focus:outline-none',
                    'focus:ring-1', 'focus:ring-violet-400', 'text-sm',
                    'rounded-lg',
                  ].join(' ')}
                />
              </div>
