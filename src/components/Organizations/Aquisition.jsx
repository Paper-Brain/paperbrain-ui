...
const AZURE_DEVOPS_LOGO_PATH = (
  "M22 18.055v2.458l-11 .587v-4.569l11-2.458V18.055zm0-12v3.818l-11 2.458V7.505l11-1.45z" +
  "m-20.5 3.257L9 8.505V13.3L1.5 11.812v-2.5zM9 19.55l-7.5-1.5v-2.5L9 17.505V19.55z" +
  "m11.5-18.5h-19C.673 1.05 0 1.722 0 2.55v3.818l9 1.188V6.5l11-1.45V2.55c0-.828-.673-1.5-1.5-1.5z"
);

const Logo = () => (
  <div className="flex items-center gap-3 mb-8">
    <svg className="w-8 h-8 text-blue-500" viewBox="0 0 24 24">
      <path fill="currentColor" d={AZURE_DEVOPS_LOGO_PATH} />
    </svg>
...
const EmailHeader = () => (
  <div className="flex justify-between items-center mb-6">
    <span className="text-sm text-gray-400">DanishFaiyaz2003@gmail.com</span>
...
const Title = () => (
  <h1 className="text-2xl font-thin mb-8">Get started with PaperBrain</h1>
);

const TermsText = () => (
  <p className="text-sm text-gray-400 mb-8">
    Choosing <span className="text-white">Continue</span> means that you agree to
    our{" "}
